...
const InstractorCard = ({ instructor }) => {
    return (
        ...
        data-aos="fade-up">
            <div
                className='p-7 shadow-md flex flex-col gap-4 border-y-4 border-transparent duration-300 hover:shadow-lg hover:border-y-4 hover:rounded-3xl hover:border-y-[#00988A] hover:scale-95'>
